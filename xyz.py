import pandas as pd
import numpy as np
sheet=pd.read_csv(r"C:\Users\White Devil\Desktop\abc\model_loc.csv",index_col='Admission Number')
...
while True:
    ...
    print("please enter the student's Roll number")
    admn_no=int(input())
        ...
        if edit == "Y":
            ...
            if det==1:
                while True:
                    ...
                    if choice=="Y":
                      abc = str(admn_no)
                      alpha = alpha.Name_Of_The_Student[abc]=value
